export function Banner() {
  return (
    <div className=" border-theme border-custom  flex h-full w-full bg-background-dark-900 lg:min-h-[calc(100vh-4rem)]">
      <div className="responsive-container w-full animate-animateOnOpen  flex-col gap-4 py-16  lg:mb-16 lg:justify-center  lg:py-0">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6    md:grid-cols-2 ">
          <div className="flex flex-col  gap-5 rounded-r-lg  border border-l-2  border-solid border-gray-800  border-l-yellow-active bg-background-dark-800 p-4 lg:gap-4  lg:p-6">
            <p className="text-xl font-semibold tracking-wider text-gray-100 opacity-90 lg:text-xl ">
          ...
          <div className="flex flex-col  gap-4 rounded-r-lg  border border-l-2  border-solid border-gray-800  border-l-yellow-active bg-background-dark-800 p-4 lg:gap-4  lg:p-6">
            <p className="text-xl font-semibold tracking-wider text-gray-100 opacity-90 lg:text-xl ">
