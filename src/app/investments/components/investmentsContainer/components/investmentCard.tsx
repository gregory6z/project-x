...
export async function InvestmentCard() {
  ...
  return (
    <Link href={"investments/dsladsa"}>
      <div className="flex h-full min-h-[60vh] w-full animate-overlayShow flex-col rounded-xl border-2 border-gray-800 bg-background-dark-900 transition-colors hover:border-yellow-hover">
