...
export function Adversiting() {
  return (
    <div className=" z-1  flex h-full w-full    bg-background-dark-900 lg:h-screen   xl:relative">
      <div className=" lg z-1  mx-[1.25rem]  my-16 flex flex-col items-center gap-16 md:flex-row md:px-4 lg:mx-auto lg:my-0 lg:max-w-[1120px] lg:justify-between lg:gap-12 lg:px-16 xl:px-0">
        ...
        <div className=" z-1   flex flex-col gap-8 font-normal text-gray-200 lg:relative lg:flex-1 lg:text-2xl xl:relative  ">
