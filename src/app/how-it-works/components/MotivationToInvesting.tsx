...
import motivationImage1 from "../../assets/como-funciona-1.jpg"
import motivationImage2 from "../../assets/como-funciona-2.jpg"
import motivationImage3 from "../../assets/como-funciona-3.jpg"
    ...
    <div className="border-custom flex h-full w-full bg-background-dark-800">
      <div className="responsive-container lg:20 my-16 flex flex-col gap-8 lg:my-32 lg:gap-20">
        <MotionElement delay={0}>
          <h1 className="text-2xl text-gray-100 lg:w-[80%]   lg:text-6xl">
